        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    Through my lens, I paint stories of Nepal's timeless spirit. From sacred peaks to ancient traditions, I capture moments where nature's grandeur dances with our rich cultural heritage.
                    </p>
                </div>
                <div>
